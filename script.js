...
// GLOBAL VARIABLES
let finalSpeech = "System Online. Welcome back, Administrator."; // Fallback
...
function detectOSForVoice() {
    ...
    if (/Android/i.test(ua)) {
        ...
        // CHANGED TEXT HERE
        finalSpeech = "System Online. Welcome to Jasa Kimjong.";
    }
}
...
function speakAI(text) {
    if ('speechSynthesis' in window) {
        ...
        msg.text = text;
        msg.volume = 1; msg.rate = 0.9; msg.pitch = 0.8; msg.lang = 'en-US';
